...
function ScrollToTopButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-40 w-11 h-11 bg-gray-800 hover:bg-gray-700 text-white rounded-full shadow-xl border border-gray-700 flex items-center justify-center transition-all"
    >
